...
/**
 * 作者：CY on 2017/2/16 16:35
 */

public class UploadHeadView extends View {
    ...
    private static final float doughnutWidthPercent = 0.20f; //圆环宽度占View最大半径的百分比
    ...
    private static int[] doughnutColors = new int[]{
            Color.argb(MIN_ALPHA, 255, 255, 255),
            Color.argb(MIN_ALPHA, 255, 255, 255),
            Color.argb(MAX_ALPHA, 255, 255, 255)};
    ...
    public UploadHeadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public UploadHeadView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.argb(MAX_ALPHA,255, 255, 255));
