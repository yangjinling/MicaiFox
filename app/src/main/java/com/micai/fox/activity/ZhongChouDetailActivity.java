...
//                yyyy.mm.dd或已筹金额达￥XXX时结束众筹
                zhongchouDetailTv1.setText("" + DateUtil.getDateToStrings(zhongChouDetailResultBean.getExecDatas().getEndDate()) + "或已筹金额达￥" + Tools.fomatMoney(String.valueOf(zhongChouDetailResultBean.getExecDatas().getAmountUp())) + "时结束众筹");
