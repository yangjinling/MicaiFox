 ...
 * 校验码: 1 0 X 9 8 7 6 5 4 3 2 所以我们就可以大致写一个函数来校验是否正确了。
 */
public class IDCardUtils {
    ...
    public static boolean IDCardValidate(String IDStr) {
        try {
            ...
            Ai = Ai + strVerifyCode;
            LogUtil.e(Constant.TAG,"新身份证号:===="+Ai);
            if (IDStr.length() == 18) {
                if (Ai.equals(IDStr) == false) {
                    errorInfo = "身份证无效，最后一位字母错误";
                    LogUtil.e(Constant.TAG, errorInfo);
                    return false;
                }
            } else {
                LogUtil.e(Constant.TAG, "所在地区:"
            ...
            // =====================(end)=====================
            //Tools.ShowSysout("所在地区:" + h.get(Ai.substring(0, 2).toString()));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        }
